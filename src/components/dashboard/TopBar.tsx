      ...
      <div className="ml-auto flex items-center gap-4">
        ...
        <div className="relative">
          ...
          >
            <Bell size={18} />
            {unreadCount > 0 && (
              <span className="absolute -top-1 -right-1 w-4 h-4 rounded-full bg-danger text-white text-caption font-mono tabular-nums font-bold flex items-center justify-center">
            ...
            <>
              ...
              <div className="fixed top-0 right-0 bottom-0 w-[360px] bg-white shadow-2xl z-50 flex flex-col animate-drawer-slide-in">
                ...
                <div className="flex items-center justify-between px-5 py-4 border-b border-gray-100">
                  <h2 className="font-display text-subhead font-semibold text-ink">Notifications</h2>
                  <button
                    onClick={() => setShowNotifs(false)}
