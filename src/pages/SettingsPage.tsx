...
export default function SettingsPage() {
  ...
  return (
    <div>
      ...
      <div className="bg-white border border-gray-200 rounded-xl p-6 max-w-lg mb-5">
      ...
      <div className="bg-white border border-gray-200 rounded-xl p-6 max-w-lg">
        ...
        <p className="text-[12.5px] text-gray-500 mb-4">Choose a colour theme for the sidebar.</p>
          ...
          {SIDEBAR_THEMES.map((t) => {
            ...
            return (
              ...
              >
                ...
                <span className="text-[12px] text-ink font-medium">{t.name}</span>
              </button>
            )
          })}
        </div>
